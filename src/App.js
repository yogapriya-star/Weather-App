...
const Api_Key = "e8e366c96848b6dea33ee077320fd3d6";
function App() {
      ...
      <div className="bg-white w-96 p-4 rounded-md">
        <div className="flex items-center justify-between"> 
          <input type="text" ref={inputRef}
            ...
            p-1 border-gray-200 font-semibold uppercase"
          />
        ...
        ${showWeather ? "h-[27rem]" : "h-0"}`}>
          {
            loading ? (<div className="grid place-items-center h-full">
              <img className="w-14 mx-auto mb-2 animate-spin" src="https://cdn-icons-png.flaticon.com/512/1477/1477009.png" alt="..." />
            </div>):(
              showWeather && (
            ...
            <h3 className="text-2xl font-bold text-zinc-800">{showWeather[0]?.type}</h3>
           {
            apiData && ( <>
              <div className="flex justify-center">
                <img className="h-9 mt-1" src="https://cdn-icons-png.flaticon.com/512/7794/7794499.png" />
